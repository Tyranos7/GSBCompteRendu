<?php
/**
 * SECTOR SEARCH RESULT VIEW
 * Displays table of visit reports for selected sector
...
<div id="contenu">
    ...
    <form method="POST" action="index.php?uc=consulterCompteRenduSecteur&action=consulterCompteRenduSecteur">
        <p>
    ...
    if(empty($rapports)){
        ...
        foreach($rapports as $rapport){
            ...
            echo "<td>" . htmlspecialchars($rapport['REG_NOM'] ?? 'N/A') . "</td>";
            ...
            echo "<td>";
            echo "<form method='POST' action='index.php?uc=consulterCompteRenduSecteur&action=detail' style='display:inline;'>";
