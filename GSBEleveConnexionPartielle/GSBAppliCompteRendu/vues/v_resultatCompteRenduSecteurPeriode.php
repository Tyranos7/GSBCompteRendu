<?php
/**
 * SECTOR PERIOD SEARCH RESULT VIEW
 * Displays table of visit reports for sector within date range
 * Used by: c_consulterCompteRenduSecteur.php
 * Variables: $rapports
 */
?>
<div id="contenu">
    <h2>Résultats de recherche - Rapports du secteur par période</h2>
    
    <form method="POST" action="index.php?uc=consulterCompteRenduPeriode&action=consulterCompteRenduPeriode">
        <p>
    ...
    if(empty($rapports)){
        ...
        foreach($rapports as $rapport){
            ...
            echo "<td>";
            echo "<form method='POST' action='index.php?uc=consulterCompteRenduPeriode&action=detail' style='display:inline;'>";
